...
export const cellmonth = styled(Box)<{ isActive: boolean }>(({ isActive }) => ({
    fontFamily: 'Poppins',
    fontSize: '15px',
    margin: '0 0 0 0 ',
    width: 45,
    ...
    padding: '10px 0',
    borderRadius: '6px',
    backgroundColor: isActive ? '#409FFF' : '',
...
export const btnaddpay = styled(TextField)({
    position: 'relative',
    textAlign: 'center',
    fontFamily: 'Poppins',
    fontSize: '14px',
...
export const divmountchrge = styled(Box)({
    position: 'relative'
});
...
export const cellpayment = styled(Box)({
    flex: 1,
    width: 200,
    ['@media (max-width:500px)']: {
        flex: '0 100%'
...
export const rowpayment = styled(Box)({
    display: 'flex'
});
...
export const titelresponse = styled(Box)({
    textAlign: 'center',
    fontFamily: 'Poppins',
    fontSize: '16px',
    margin: '10px 0 50px 0',
...
export const MyButtoncall = styled(Button)({
...
export const warper = styled(Box)({
    margin: '0 0 0 20px',
    width: '95%'
});
export const textwalet = styled(Box)({
    textAlign: 'center',
    fontFamily: 'Poppins',
    fontSize: '14px',
    padding: '31px 0 0 0'
});
export const textpaywallet = styled(Box)({
    textAlign: 'center',
    fontFamily: 'Poppins',
    fontSize: '14px',
    margin: '20px 5px',
...
export const rowpagewallet = styled(Box)({
    display: 'flex',
    width: 250,
    margin: '0 auto'
});
