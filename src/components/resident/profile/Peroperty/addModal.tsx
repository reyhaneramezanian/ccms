...
const PeropertyAddModal: FC<IModalBodyProps<RowTable>> = ({ data }) => {
    const dispatch = useDispatch();
    const { mutate, isLoading } = useResidentFlat_CreateMutation();
...
const handlepropertyAddModal = (data?: RowTable) => {
    return newModal({
