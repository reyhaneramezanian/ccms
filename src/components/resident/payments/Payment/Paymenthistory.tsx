...
import { ColumnPaymentsHistory, ColumnPaymentsMaintenancesHistory } from '../data';
...
const Complaint = () => {
        ...
        where:
            list.length != 0
                ...
                : {
                      ...
                      paymentStatus: { eq: PaymentStatus.Paid },
                      maintenanceType: { name: { contains: pageData.searchdata } }
                  },
    ...
    const props = {
        ...initialProps,
        columns: Curent === 'Utility' ? ColumnPaymentsHistory : ColumnPaymentsMaintenancesHistory,
