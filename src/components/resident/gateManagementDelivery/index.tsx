...
const GateManagementDelivery = () => {
    ...
    const { tabs, activeTab } = useManageTab(GATE_MANAGEMENT_TABS_ITEMS);
    ...
    const { activeQuery, data, setSearchValue, setRows, isLoading } = useManageTabsQueries<any>(
        ...
        activeTab,
        {
            ...
            othersFilter: {
                [EGateManagementTabsKey.Delivery]: Filter
            }
            //  whereType: 'and'
        }
    );
...
export default GateManagementDelivery;
