...
const PeaplemanagementAddModal: FC<IModalBodyProps<RowTable>> = ({ data }) => {
    ...
    const { mutate, isLoading } = useUser_CreateStaffMutation();
    ...
    useEffect(() => {
        ...
        setcomplexlist(js);
    }, [datacomplex, totalbuilding, complexUser.isLoading]);
        ...
        mutate(
            {
                input: {
                    ...
                    activeStatus: e.Status as any,
                    firstName: e.Firstname,
                    lastName: e.Surname,
                    dateOfBirth: e.Dateofbirth,
                    phoneNumber: e.Primaryphone,
                    email: e.Primaryemail.trim(),
            ...
            },
            {
                ...
                onError: (err) => {
                    mutationErrorHandler(err, 'user_createStaff');
                }
            }
        );
    };
        ...
        <Box style={{ width: 1440, maxWidth: '90vw' }}>
            ...
            <Formik
                ...
                initialValues={{
                    ...
                    Employeetype: '',
                    Dateofterminaition: new Date().toJSON().slice(0, 10)
                }}
...
const handleStaffAddModal = (data?: RowTable) => {
    return newModal({
