        ...
        <adminstyle.modalbox style={{ width: 700 }}>
            <adminstyle.modalFormRowWrapper>
                <Grid container>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6}>
                        <adminstyle.titledetail>Alternative contact</adminstyle.titledetail>
                    ...
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        ...
                        <adminstyle.textdetail title={row.Complexname}>
                            {row.Complexname}
                        </adminstyle.textdetail>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <adminstyle.titledetail>Block </adminstyle.titledetail>
                        <adminstyle.textdetail>{row.Blockname}</adminstyle.textdetail>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <adminstyle.titledetail>Floor </adminstyle.titledetail>
                        <adminstyle.textdetail>{row.Floorname}</adminstyle.textdetail>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
                        <adminstyle.titledetail>Flat </adminstyle.titledetail>
                        <adminstyle.textdetail>{row.Flatname}</adminstyle.textdetail>
                    </Grid>
                    <Grid item xs={12} sm={12} md={4} lg={4}>
