...
import { useBlock_UpdateMutation, useComplex_GetComplexesQuery } from 'src/graphql/generated';
import { useDispatch, useSelector } from 'react-redux';
import React, { useEffect, useState } from 'react';
import { setPageData } from 'src/redux/actions/actions';
import { residentFilterInitialForm } from '../data';
...
const BuildingConfigurationFilterModal: FC<IModalBodyProps<RowTable>> = ({
    ...
    const handelReset = () => {
        setState(residentFilterInitialForm());
