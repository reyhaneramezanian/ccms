...
import {
    useUser_CreateSecurityMutation,
...
const PeaplemanagementAddModal: FC<IModalBodyProps<RowTable>> = ({ data }) => {
    ...
    const { mutate, isLoading } = useUser_CreateSecurityMutation();
    ...
    const handelsave = (e) => {
        mutate(
            ...
            },
            {
                ...
                onError: (err) => {
                    mutationErrorHandler(err, 'user_createSecurity');
                }
            }
        );
    };
        ...
        <Box style={{ width: 1440, maxWidth: '90vw' }}>
            <Formik
                ...
                initialValues={{
                    ...
                    dateOfTermination: new Date().toJSON().slice(0, 10)
                }}
...
const handleSecurityAddModal = (data?: RowTable) => {
    return newModal({
