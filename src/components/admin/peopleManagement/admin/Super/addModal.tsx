...
import { useUser_CreateSuperAdminMutation } from 'src/graphql/generated';
...
const PeaplemanagementAddModal: FC<IModalBodyProps<RowTable>> = ({ data }) => {
    ...
    const { mutate, isLoading } = useUser_CreateSuperAdminMutation();
    ...
    const handelsave = (data) => {
        mutate(
            ...
            },
            {
                ...
                onError: (err) => {
                    mutationErrorHandler(err, 'user_createSuperAdmin');
                }
            }
        );
    };
