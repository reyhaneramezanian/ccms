...
import { paymentsFilterInitialForm, ValidationForm } from './data';
...
const PaymentsFilterModal: FC<IModalBodyProps<RowTable>> = ({ data: { state, setState } }) => {
    ...
    const handleResetFilters = () => {
        setState(paymentsFilterInitialForm());
                    ...
                    <Grid item lg={3} xs={12}>
                        <adminstyle.modalFormRowFieldWrapper>
                            <MSelect
                                name="utilityType"
                                label="Utility type"
                                options={utilityRateOptions}
                                value={formik.values.utilityType}
                                onChange={formik.handleChange}
                                meta={formik.getFieldMeta('utilityType')}
                                necessary={false}
                            />
                        </adminstyle.modalFormRowFieldWrapper>
                    </Grid>
