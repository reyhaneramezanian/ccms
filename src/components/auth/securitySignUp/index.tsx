...
import { UserType, useSecuritySignupMutation, ActiveStatus } from 'src/graphql/generated';
...
const SecuritySignUp = () => {
    ...
    const signUpMutation = useSecuritySignupMutation();
            ...
            await signUpMutation.mutateAsync(
                {
                    input: {
                        ...
                        employmentTypeId: data.employeeType,
                ...
                },
                {
                    ...
                    onError(err: any) {
                        ...
                        if (err?.user_signupSecurity?.status?.code !== 1) {
                            enqueueSnackbar(err.user_signupSecurity.status?.value, {
                                variant: 'error'
                            });
                            return;
                        }
