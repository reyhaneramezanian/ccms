...
const ComplaintMenuIcon = ({ width = 24, height = 24, color = '#7a7a7a' }: IIcon) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24">
            <g
                id="vuesax_linear_warning-2"
                data-name="vuesax/linear/warning-2"
                transform="translate(-172 -700)">
                <g id="warning-2">
                    <path
                        id="Vector"
                        d="M0,0V5.25"
                        transform="translate(184 707.75)"
                        fill="none"
                        stroke={color}
                        strokeLinecap="round"
                    ...
                    <path
                        ...
                        transform="translate(174.91 702)"
                        fill="none"
                        stroke={color}
                        strokeLinecap="round"
                        strokeLinejoin="round"
